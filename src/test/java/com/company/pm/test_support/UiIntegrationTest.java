package com.company.pm.test_support;

import com.company.pm.PmApplicationApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "pm_MainScreen", screenBasePackages = "com.company.pm.screen")
@ContextConfiguration(classes = {PmApplicationApplication.class, UiTestAssistConfiguration.class})
